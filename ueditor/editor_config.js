...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[["FullScreen","Source","|","Undo","Redo","InsertUnorderedList","InsertOrderedList","Unlink","Link","ClearDoc","SelectAll","Print","SearchReplace","Preview","Help"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'fullscreen':'','source':'','|':'','undo':'','redo':'','insertunorderedlist':'','insertorderedlist':'','unlink':'','link':'','cleardoc':'','selectall':'','print':'','searchreplace':'','preview':'','help':''}
        ...
        ,initialContent:"记录生活中的点点滴滴!"    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
